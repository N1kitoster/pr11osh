...
<html>
	...
	const secretKey = "qazxswedcvfrtgbn";
        ...
        let MessageRaw = sender.parentElement.children[0].value;
        let IdPost = sender.parentElement.id;
        if(MessageRaw == "") return;

        
        let encryptedMessage = encryptAES(MessageRaw, secretKey);
        let encryptedIdPost = encryptAES(IdPost, secretKey);

        var Data = new FormData();
        Data.append("Message", encryptedMessage); 
        Data.append("IdPost", encryptedIdPost);
